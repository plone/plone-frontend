...
- `17`, `17.5`, `17.5.0`, `latest` [(17.x/Dockerfile)](https://github.com/plone/plone-frontend/blob/17.x/Dockerfile)

- `16`, `16.26`, `16.26.0` [(16.x/D ockerfile)](https://github.com/plone/plone-frontend/blob/16.x/Dockerfile)
