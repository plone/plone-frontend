...
- `latest, 15, 15.12, 15.12.2` [(15.12.1/Dockerfile)](https://github.com/plone/plone-frontend/blob/v15.12.2/Dockerfile)

### Next version

- `16.0.0-alpha.18` [(16.0.0-alpha.18/Dockerfile)](https://github.com/plone/plone-frontend/blob/v16.0.0-alpha.18/Dockerfile)
